// lab 4
// Реализовать класс Письмо. Гарантировать корректность данных в Письме.
// Создать меню, где можно добавлять, отображать и удалять (по отправителю или слову в теле)
// письма, а также выходить из приложения.

using System;
using System.Collections.Generic;

namespace Bsuir.AaDs.Cs.Sample5
{
    public class Letter
    {
        private string from;
        ...
        {
            get { return from; }
            private set { Validate("From", value); from = value; }
        }
        ...
        {
            get { return to; }
            private set { Validate("To", value); to = value; }
        }
        ...
        {
            get { return forward; }
            private set { Validate("Forward", value); forward = value; }
        }
        ...
        {
            get { return subject; }
            private set { Validate("Subject", value); subject = value; }
        }
        ...
        {
            get { return body; }
            private set { Validate("Body", value); body = value;  }
        }
