...
public:
  ...
  virtual ~Computer() {
    std::cout << "Is Computer: true" << std::endl;
  }
...
public:
  Desktop(const std::string& model, const std::string& type, const bool is_upgradeable)
  ...
  virtual ~Desktop() {
    std::cout << "Is Desktop: true" << std::endl;
  }
...
public:
  ...
  virtual ~Monoblock() {
    std::cout << "Is Monoblock: true" << std::endl;
  }
...
public:
  Portable(const std::string& model, const std::string& type, const bool has_touchpad)
  ...
  virtual ~Portable() {
    std::cout << "Is Portable: true" << std::endl;
  }
...
public:
  Notebook(const std::string& model = "NB", const std::string& battery_type = "Li-ion")
  ...
  virtual ~Notebook() {
    std::cout << "Is Notebook: true" << std::endl;
  }
...
std::tuple<std::unique_ptr<Computer>, int> make_computer_of_type(
...
std::tuple<std::unique_ptr<Computer>, int> create_computer() {
  ...
  auto computer = make_computer_of_type(computer_type);
...
int main() {
  ...
  std::tie(computer, error_code) = create_computer();
  ...
  std::cout << std::endl << "Your computer info: "
    << std::endl << *computer << std::endl;
